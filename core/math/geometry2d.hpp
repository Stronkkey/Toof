...
*/
constexpr bool is_point_inside_circle(const real_t circle_radius, const Vector2 &point, const Vector2 &circle_position = Vector2::ZERO) {
...
*/
constexpr bool are_circles_intersecting(const real_t left_circle_radius, const Vector2 &left_circle_position, const real_t right_circle_radius, const Vector2 &right_circle_position) {
...
*/
constexpr std::optional<Vector2> line_intersects_line(const Vector2 &from_a, const Vector2 &dir_a, const Vector2 &from_b, const Vector2 &dir_b) {
...
*/
constexpr bool is_direction_intersecting_direction(const Vector2 &dir_a, const Vector2 &dir_b) {
	const real_t denom = dir_b.y * dir_a.x - dir_b.x * dir_a.y;
