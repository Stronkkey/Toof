...
Color::Color(const Color &from, const uint16_t alpha): r(from.r), g(from.g), b(from.b), a(alpha)
{}

Color::Color(const Color &from): r(from.r), g(from.g), b(from.b), a(from.a)
{}

Color::Color(const uint16_t red, const uint16_t green, const uint16_t blue): r(red), g(green), b(blue), a(255)
{}

Color::Color(const uint16_t red, const uint16_t green, const uint16_t blue, const uint16_t alpha): r(red), g(green), b(blue), a(alpha)
{}
